...
_G.packer_plugins = {
  ...
  ["nnn.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ali/.local/share/nvim/site/pack/packer/opt/nnn.nvim",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-autopairs', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
