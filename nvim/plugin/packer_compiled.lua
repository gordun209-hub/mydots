...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "friendly-snippets", "cmp_luasnip", "cmp-nvim-lua" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-surround', 'nvim-cmp', 'LuaSnip', 'lsp_signature.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
