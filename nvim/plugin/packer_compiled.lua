...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "friendly-snippets", "cmp_luasnip", "nvim-autopairs", "cmp-nvim-lua" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'lsp_signature.nvim', 'LuaSnip', 'nvim-cmp', 'nvim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
