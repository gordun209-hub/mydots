...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp_luasnip", "nvim-autopairs", "friendly-snippets" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-colorizer.lua", "nvim-ts-autotag" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'lsp_signature.nvim', 'nvim-surround', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
