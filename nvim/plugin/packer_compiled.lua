...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'lsp_signature.nvim', 'nvim-surround', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
