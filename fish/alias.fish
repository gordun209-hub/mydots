...
alias fishrc="nvim ~/dotfiles/fish/config.fish"
alias zathurarc="nvim ~/dotfiles/zathura/zathurarc"
alias leftwmrc="nvim ~/dotfiles/leftwm/config.toml"
alias xmonadrc="nvim ~/dotfiles/xmonad/xmonad.hs"
alias nushellrc="nvim ~/dotfiles/nushell/config.nu"
alias weztermrc="nvim ~/dotfiles/wezterm/wezterm.lua"
alias joshutorc="nvim ~/dotfiles/joshuto/joshuto.toml"
alias lfrc="nvim ~/dotfiles/lf/lfrc"
alias picomrc="nvim ~/dotfiles/picom/picom.conf"
alias starshiprc="nvim ~/dotfiles/starship/starship.toml"
alias terminatorrc="nvim ~/dotfiles/terminator/config"
alias zelijjrc="nvim ~/dotfiles/zellij/config.yaml"
#fix obvious typo's
alias cd..="cd .."
alias pdw="pwd"
