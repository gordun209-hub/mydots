...
alias alacrittyrc="nvim ~/dots/alacritty/alacritty.yml"
alias kittyrc="nvim ~/dots/kitty/kitty.conf"
alias fishrc="nvim ~/dots/fish/config.fish"
alias zathurarc="nvim ~/dots/zathura/zathurarc"
alias leftwmrc="nvim ~/dots/leftwm/config.toml"
alias xmonadrc="nvim ~/dots/xmonad/xmonad.hs"
alias nushellrc="nvim ~/dots/nushell/config.nu"
alias weztermrc="nvim ~/dots/wezterm/wezterm.lua"
alias joshutorc="nvim ~/dots/joshuto/joshuto.toml"
alias lfrc="nvim ~/dots/lf/lfrc"
alias picomrc="nvim ~/dots/picom/picom.conf"
alias starshiprc="nvim ~/dots/starship/starship.toml"
alias terminatorrc="nvim ~/dots/terminator/config"
alias zelijjrc="nvim ~/dots/zellij/config.yaml"
#fix obvious typo's
alias cd..="cd .."
alias pdw="pwd"
